...
def edgeshaper(model, data, x, E,batch, smi_em,M=100, target_class=1, P=None, log_odds=True, seed=42, device="cpu"):
...
def nodeshaper(model, data, x, E, batch, a,b,c, device,M=100, target_class=0, P=None, log_odds=True, seed=42):
    rng = default_rng(seed=seed)
    model.eval()
    phi_nodes = []
