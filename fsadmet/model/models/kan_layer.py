...
class KANLinear(torch.nn.Module):
    def __init__(
        ...
        # print(f'self.in_features : ', in_features)
        # print(f'self.out_features : ', out_features)
...
class GINWithKAN(nn.Module):
    def __init__(self, in_features, 
        ...
        super(GINWithKAN, self).__init__()
...
# class GINWithKAN(torch.nn.Module):
#     def __init__(self, in_features, 
#                  out_features,
#                  grid_size=5,
#                  spline_order=3,
